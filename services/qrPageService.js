/**
 * Returns an HTML page that displays a QR code from base64 data.
 * This is useful in cloud deployments where there's no terminal to print the QR.
 */
function getQrPage(qrBase64) {
    if (!qrBase64) {
        return `
<!DOCTYPE html>
<html>
...
<div class="card">
    ...
    <p>Send expenses to yourself on WhatsApp.</p>
</div>
</body>
</html>`;
    }
